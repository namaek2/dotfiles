...
hl.bind("SUPER + SHIFT + code:201", hl.dsp.exec_cmd("/home/namaek2/.hermes/hermes-agent/venv/bin/hermes desktop")) 

-- App launchers and basic actions
--hl.bind(mainMod .. " + H",         hl.dsp.exec_cmd("/home/namaek2/.hermes/hermes-agent/venv/bin/hermes desktop"))
...
-- Resize (vim style) — bind = repeating
